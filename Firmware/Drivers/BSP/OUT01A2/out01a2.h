/**
  ...
  * @brief   Header for out01a2.c module
  ******************************************************************************
  * @attention
  *
...
/** @defgroup OUT01A2_Exported_Types OUT01A2 Exported Types
  * @{
  */
...
typedef struct
{
  /** PWM Frequency */
  uint32_t pwmFreq;
} OUT01_SWITCH_Init_Parameters_t;
...
/** @defgroup OUT01A2_Exported_Constants OUT01A2 Exported Constants
  * @{
  */

/** CHIP ID  */
#define OUT01_SWITCH_CHIP_ID IPS_SWITCH_CHIP_ID

/** Number of supported switch instances*/
#define OUT01_SWITCH_INSTANCES_NBR (1U)

/** Number of supported switch devices*/
#define OUT01_SWITCH_DEVICES_NBR IPS_SWITCH_DEVICES_NBR

/** Direct Control mode setting */
#define OUT01_SWITCH_DIRECT_CTRL_MODE IPS_SWITCH_DIRECT_CTRL_MODE

/** Synchronous Control mode setting */
#define OUT01_SWITCH_SYNC_CTRL_MODE IPS_SWITCH_SYNC_CTRL_MODE

/* Board 0 */
/** Input Pin: IN1 */
#define OUT01_SWITCH_0_IN1 IPS_SWITCH_0_IN1
/** Input Pin: IN2 */
#define OUT01_SWITCH_0_IN2 IPS_SWITCH_0_IN2
/** Input Pin: IN3 */
#define OUT01_SWITCH_0_IN3 IPS_SWITCH_0_IN3
/** Input Pin: IN4 */
#define OUT01_SWITCH_0_IN4 IPS_SWITCH_0_IN4
/** Input Pin: IN5 */
#define OUT01_SWITCH_0_IN5 IPS_SWITCH_0_IN5
/** Input Pin: IN6 */
#define OUT01_SWITCH_0_IN6 IPS_SWITCH_0_IN6
/** Input Pin: IN7 */
#define OUT01_SWITCH_0_IN7 IPS_SWITCH_0_IN7
/** Input Pin: IN8 */
#define OUT01_SWITCH_0_IN8 IPS_SWITCH_0_IN8
/** Control Pin: LOAD */
#define OUT01_SWITCH_0_CTRL_LOAD IPS_SWITCH_0_CTRL_LOAD
/** Control Pin: OUT_EN */
#define OUT01_SWITCH_0_CTRL_OUT_EN IPS_SWITCH_0_CTRL_OUT_EN
/** Control Pin: SYNCH */
#define OUT01_SWITCH_0_CTRL_SYNCH IPS_SWITCH_0_CTRL_SYNCH

/** IN1 Port 0 */
#define OUT01_SWITCH_0_IN1_GPIO_PORT IPS_SWITCH_0_IN1_GPIO_PORT
/** IN1 Pin 0 */
#define OUT01_SWITCH_0_IN1_GPIO_PIN IPS_SWITCH_0_IN1_GPIO_PIN
/** IN2 Port 0 */
#define OUT01_SWITCH_0_IN2_GPIO_PORT IPS_SWITCH_0_IN2_GPIO_PORT
/** IN2 Pin 0 */
#define OUT01_SWITCH_0_IN2_GPIO_PIN IPS_SWITCH_0_IN2_GPIO_PIN
/** IN3 Port 0 */
#define OUT01_SWITCH_0_IN3_GPIO_PORT IPS_SWITCH_0_IN3_GPIO_PORT
/** IN3 Pin 0 */
#define OUT01_SWITCH_0_IN3_GPIO_PIN IPS_SWITCH_0_IN3_GPIO_PIN
/** IN4 Port 0 */
#define OUT01_SWITCH_0_IN4_GPIO_PORT IPS_SWITCH_0_IN4_GPIO_PORT
/** IN4 Pin 0 */
#define OUT01_SWITCH_0_IN4_GPIO_PIN IPS_SWITCH_0_IN4_GPIO_PIN
/** IN5 Port 0 */
#define OUT01_SWITCH_0_IN5_GPIO_PORT IPS_SWITCH_0_IN5_GPIO_PORT
/** IN5 Pin 0 */
#define OUT01_SWITCH_0_IN5_GPIO_PIN IPS_SWITCH_0_IN5_GPIO_PIN
/** IN6 Port 0 */
#define OUT01_SWITCH_0_IN6_GPIO_PORT IPS_SWITCH_0_IN6_GPIO_PORT
/** IN6 Pin 0 */
#define OUT01_SWITCH_0_IN6_GPIO_PIN IPS_SWITCH_0_IN6_GPIO_PIN
/** IN7 Port 0 */
#define OUT01_SWITCH_0_IN7_GPIO_PORT IPS_SWITCH_0_IN7_GPIO_PORT
/** IN7 Pin 0 */
#define OUT01_SWITCH_0_IN7_GPIO_PIN IPS_SWITCH_0_IN7_GPIO_PIN
/** IN8 Port 0 */
#define OUT01_SWITCH_0_IN8_GPIO_PORT IPS_SWITCH_0_IN8_GPIO_PORT
/** IN8 Pin 0 */
#define OUT01_SWITCH_0_IN8_GPIO_PIN IPS_SWITCH_0_IN8_GPIO_PIN

/** LOAD Port 0 */
#define OUT01_SWITCH_0_LOAD_GPIO_PORT IPS_SWITCH_0_LOAD_GPIO_PORT
/** LOAD Pin 0 */
#define OUT01_SWITCH_0_LOAD_GPIO_PIN IPS_SWITCH_0_LOAD_GPIO_PIN
/** OUT_EN Port 0 */
#define OUT01_SWITCH_0_OUT_EN_GPIO_PORT IPS_SWITCH_0_OUT_EN_GPIO_PORT
/** OUT_EN Pin 0 */
#define OUT01_SWITCH_0_OUT_EN_GPIO_PIN IPS_SWITCH_0_OUT_EN_GPIO_PIN
/** SYNCH Port 0 */
#define OUT01_SWITCH_0_SYNCH_GPIO_PORT IPS_SWITCH_0_SYNCH_GPIO_PORT
/** SYNCH Pin 0 */
#define OUT01_SWITCH_0_SYNCH_GPIO_PIN IPS_SWITCH_0_SYNCH_GPIO_PIN
/** ISO_DRV Port 0 */
#define OUT01_SWITCH_0_ISO_DRV_GPIO_PORT IPS_SWITCH_0_ISO_DRV_GPIO_PORT
/** ISO DRV Pin 0 */
#define OUT01_SWITCH_0_ISO_DRV_GPIO_PIN IPS_SWITCH_0_ISO_DRV_GPIO_PIN

/** STATUS Port 0 */
#define OUT01_SWITCH_0_STATUS_GPIO_PORT IPS_SWITCH_0_STATUS_GPIO_PORT
/** STATUS Pin 0 */
#define OUT01_SWITCH_0_STATUS_GPIO_PIN IPS_SWITCH_0_STATUS_GPIO_PIN
...
/** @addtogroup OUT01A2_Exported_Variables OUT01A2 Exported Variables
  * @{
  */

extern void *SWITCH_CompObj[OUT01_SWITCH_INSTANCES_NBR];
...
/** @addtogroup OUT01A2_Exported_Functions OUT01A2 Exported Functions
  * @{
  */
