/**
  ...
  * @brief   IPS1025H (High Efficiency High Side Switch) driver
  ******************************************************************************
  * @attention
  *
...
/** @defgroup IPS1025H_Global_Variables IPS1025H Global Variables
  * @{
  */

/** Common driver structure which lists IPS1025H functions */
IPS1025H_CommonDrv_t IPS1025H_COMMON_Driver =
{
  IPS1025H_Init,
  IPS1025H_DeInit,
  IPS1025H_ReadID,
  IPS1025H_GetCapabilities,
  IPS1025H_GetFaultStatus,
  IPS1025H_GetChannelStatus,
  IPS1025H_SetChannelStatus,
  IPS1025H_GetAllChannelStatus,
  IPS1025H_SetAllChannelStatus,
  IPS1025H_GetChannelFreq,
  IPS1025H_SetChannelFreq,
  IPS1025H_GetChannelDc,
  IPS1025H_SetChannelDc,
  IPS1025H_GetPwmEnable,
  IPS1025H_SetPwmEnable,
  IPS1025H_PwmTick
};
...
/** @defgroup IPS1025H_Private_Variables IPS1025H Private Variables
  * @{
  */
...
/** @defgroup IPS1025H_Private_Function_Prototypes IPS1025H Private Function Prototypes
  * @{
  */

static int32_t IPS1025H_Initialize(IPS1025H_Object_t *pObj);
...
/** @defgroup IPS1025H_Functions_Definition IPS1025H Functions Definition
  * @{
  */
...
/**
  * @brief  Initialize the IPS1025H switch
  * @param  pObj pointer to the device object
  * @retval 0 in case of success, an error code otherwise
  */
int32_t IPS1025H_Init(IPS1025H_Object_t *pObj)
{
  ...
  {
    if (IPS1025H_Initialize(pObj) != IPS_SWITCH_OK)
    {
    ...
    {
      IPS_NbInstances++;
      if (IPS_NbInstances > IPS1025H_INSTANCES_NBR)
      {
        status = IPS_SWITCH_ERROR;
      }
      else
...
/**
  * @brief  Deinitialize the IPS1025H switch
  * @param  pObj pointer to the device object
  * @retval 0 in case of success, an error code otherwise
  */
int32_t IPS1025H_DeInit(IPS1025H_Object_t *pObj)
{
  ...
  if (pObj->is_initialized == 1U)
  {
    ...
    {
        (void)IPS1025H_SetPwmEnable(pObj, (uint8_t)loop, 0U);
    }

     /* Disable all channels */
    (void)IPS1025H_SetAllChannelStatus(pObj, 0U);
...
/**
  * @brief  Get IPS1025H switch capabilities
  * @param  pObj pointer to the device object
...
int32_t IPS1025H_GetCapabilities(IPS1025H_Object_t *pObj, IPS1025H_Capabilities_t *pCapabilities)
{
  ...
  if (pObj->chipId == IPS1025H_CHIP_ID)
  {
    pCapabilities->nbChannels    = 1U;
  }
  else
  {
    status = IPS_SWITCH_ERROR;
...
int32_t IPS1025H_SetChannelFreq(IPS1025H_Object_t *pObj, uint8_t ChanId, uint16_t ChanFreq)
{
  ...
  {
    uint16_t newFreq;
    if (ChanFreq > IPS1025H_MAX_CHAN_FREQ)
    {
       newFreq = IPS1025H_MAX_CHAN_FREQ;
    }
    else
    {
      newFreq = ChanFreq;
...
static int32_t IPS1025H_Initialize(IPS1025H_Object_t *pObj)
{
  ...
  if (IPS1025H_SetAllChannelStatus(pObj, 0U) != IPS_SWITCH_OK)
  {
    ret = IPS_SWITCH_ERROR;
  }
  return ret;
