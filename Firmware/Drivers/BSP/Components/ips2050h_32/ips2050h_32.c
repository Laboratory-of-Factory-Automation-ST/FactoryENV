/**
  ...
  * @brief   IPS2050H_32 (High Efficiency Dual High Side) driver
  ******************************************************************************
  * @attention
  *
...
/** @defgroup IPS2050H_32_Global_Variables IPS2050H_32 Global Variables
  * @{
  */

/** Common driver structure which lists IPS2050H_32 functions */
IPS2050H_32_CommonDrv_t IPS2050H_32_COMMON_Driver =
{
  IPS2050H_32_Init,
  IPS2050H_32_DeInit,
  IPS2050H_32_ReadID,
  IPS2050H_32_GetCapabilities,
  IPS2050H_32_GetFaultStatus,
  IPS2050H_32_GetChannelStatus,
  IPS2050H_32_SetChannelStatus,
  IPS2050H_32_GetAllChannelStatus,
  IPS2050H_32_SetAllChannelStatus,
  IPS2050H_32_GetChannelFreq,
  IPS2050H_32_SetChannelFreq,
  IPS2050H_32_GetChannelDc,
  IPS2050H_32_SetChannelDc,
  IPS2050H_32_GetPwmEnable,
  IPS2050H_32_SetPwmEnable,
  IPS2050H_32_PwmTick
};
...
/** @defgroup IPS2050H_32_Private_Variables IPS2050H_32 Private Variables
  * @{
  */
...
/** @defgroup IPS2050H_32_Private_Function_Prototypes IPS2050H_32 Private Function Prototypes
  * @{
  */

static int32_t IPS2050H_32_Initialize(IPS2050H_32_Object_t *pObj);
...
/** @defgroup IPS2050H_32_Functions_Definition IPS2050H_32 Functions Definition
  * @{
  */
...
/**
  * @brief  Initialize the IPS2050H_32 switch
  * @param  pObj pointer to the device object
  * @retval 0 in case of success, an error code otherwise
  */
int32_t IPS2050H_32_Init(IPS2050H_32_Object_t *pObj)
{
  ...
  {
    if (IPS2050H_32_Initialize(pObj) != IPS_SWITCH_OK)
    {
    ...
    {
      IPS_NbInstances++;
      if (IPS_NbInstances > IPS2050H_32_INSTANCES_NBR)
      {
        status = IPS_SWITCH_ERROR;
      }
      else
...
/**
  * @brief  Deinitialize the IPS2050H_32 switch
  * @param  pObj pointer to the device object
  * @retval 0 in case of success, an error code otherwise
  */
int32_t IPS2050H_32_DeInit(IPS2050H_32_Object_t *pObj)
{
  ...
  if (pObj->is_initialized == 1U)
  {
    ...
    {
        (void)IPS2050H_32_SetPwmEnable(pObj, (uint8_t)loop, 0U);
    }

     /* Disable all channels */
    (void)IPS2050H_32_SetAllChannelStatus(pObj, 0U);
...
/**
  * @brief  Get IPS2050H_32 switch capabilities
  * @param  pObj pointer to the device object
...
int32_t IPS2050H_32_GetCapabilities(IPS2050H_32_Object_t *pObj, IPS2050H_32_Capabilities_t *pCapabilities)
{
  ...
  if (pObj->chipId == IPS2050H_32_CHIP_ID)
  {
    pCapabilities->nbChannels    = 2U;
  }
  else
  {
    status = IPS_SWITCH_ERROR;
...
int32_t IPS2050H_32_SetChannelFreq(IPS2050H_32_Object_t *pObj, uint8_t ChanId, uint16_t ChanFreq)
{
  ...
  {
    uint16_t newFreq;
    if (ChanFreq > IPS2050H_32_MAX_CHAN_FREQ)
    {
       newFreq = IPS2050H_32_MAX_CHAN_FREQ;
    }
    else
    {
      newFreq = ChanFreq;
...
static int32_t IPS2050H_32_Initialize(IPS2050H_32_Object_t *pObj)
{
  ...
  if (IPS2050H_32_SetAllChannelStatus(pObj, 0U) != IPS_SWITCH_OK)
  {
    ret = IPS_SWITCH_ERROR;
  }
  return ret;
