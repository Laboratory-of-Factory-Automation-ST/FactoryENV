...
/** @defgroup IPS8160HQ_1_Global_Variables IPS8160HQ_1 Global Variables
  * @{
  */

/** Common driver structure which lists IPS8160HQ_1 functions */
IPS8160HQ_1_CommonDrv_t IPS8160HQ_1_COMMON_Driver =
{
  IPS8160HQ_1_Init,
  IPS8160HQ_1_DeInit,
  IPS8160HQ_1_ReadID,
  IPS8160HQ_1_GetCapabilities,
  IPS8160HQ_1_GetFaultStatus,
  IPS8160HQ_1_GetChannelStatus,
  IPS8160HQ_1_SetChannelStatus,
  IPS8160HQ_1_GetAllChannelStatus,
  IPS8160HQ_1_SetAllChannelStatus,
  IPS8160HQ_1_GetChannelFreq,
  IPS8160HQ_1_SetChannelFreq,
  IPS8160HQ_1_GetChannelDc,
  IPS8160HQ_1_SetChannelDc,
  IPS8160HQ_1_GetPwmEnable,
  IPS8160HQ_1_SetPwmEnable,
  IPS8160HQ_1_PwmTick
};
...
/** @defgroup IPS8160HQ_1_Private_Variables IPS8160HQ_1 Private Variables
  * @{
  */
...
/** @defgroup IPS8160HQ_1_Private_Function_Prototypes IPS8160HQ_1 Private Function Prototypes
  * @{
  */

static int32_t IPS8160HQ_1_Initialize(IPS8160HQ_1_Object_t *pObj);
...
/**
  * @brief  Initialize the IPS8160HQ_1 switch
  * @param  pObj pointer to the device object
  * @retval 0 in case of success, an error code otherwise
  */
int32_t IPS8160HQ_1_Init(IPS8160HQ_1_Object_t *pObj)
{
  ...
  {
    if (IPS8160HQ_1_Initialize(pObj) != IPS_SWITCH_OK)
    {
    ...
    {
      IPS_NbInstances++;
      if (IPS_NbInstances > IPS8160HQ_1_INSTANCES_NBR)
      {
        status = IPS_SWITCH_ERROR;
      }
      else
...
/**
  * @brief  Deinitialize the IPS8160HQ_1 switch
  * @param  pObj pointer to the device object
  * @retval 0 in case of success, an error code otherwise
  */
int32_t IPS8160HQ_1_DeInit(IPS8160HQ_1_Object_t *pObj)
{
  ...
  if (pObj->is_initialized == 1U)
  {
    ...
    {
      (void)IPS8160HQ_1_SetPwmEnable(pObj, (uint8_t)loop, 0U);
    }

     /* Disable all channels */
    (void)IPS8160HQ_1_SetAllChannelStatus(pObj, 0U);
...
/**
  * @brief  Get IPS8160HQ_1 switch capabilities
  * @param  pObj pointer to the device object
...
int32_t IPS8160HQ_1_GetCapabilities(IPS8160HQ_1_Object_t *pObj, IPS8160HQ_1_Capabilities_t *pCapabilities)
{
  ...
  if (pObj->chipId == IPS8160HQ_1_CHIP_ID)
  {
    pCapabilities->nbChannels = IPS8160HQ_1_MAX_NB_CHANNELS;
  }
  else
  {
    status = IPS_SWITCH_ERROR;
...
int32_t IPS8160HQ_1_SetChannelFreq(IPS8160HQ_1_Object_t *pObj, uint8_t ChanId, uint16_t ChanFreq)
{
  ...
  {
    uint16_t newFreq;
    if (ChanFreq > IPS8160HQ_1_MAX_CHAN_FREQ)
    {
       newFreq = IPS8160HQ_1_MAX_CHAN_FREQ;
    }
    else
    {
      newFreq = ChanFreq;
...
static int32_t IPS8160HQ_1_Initialize(IPS8160HQ_1_Object_t *pObj)
{
  ...
  if (IPS8160HQ_1_SetAllChannelStatus(pObj, 0U) != IPS_SWITCH_OK)
  {
    ret = IPS_SWITCH_ERROR;
  }
  return ret;
