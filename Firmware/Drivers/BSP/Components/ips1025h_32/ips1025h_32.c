/**
  ...
  * @brief   IPS1025H_32 (High Efficiency High Side Switch) driver
  ******************************************************************************
  * @attention
  *
...
/** @defgroup IPS1025H_32_Global_Variables IPS1025H_32 Global Variables
  * @{
  */

/** Common driver structure which lists IPS1025H_32 functions */
IPS1025H_32_CommonDrv_t IPS1025H_32_COMMON_Driver =
{
  IPS1025H_32_Init,
  IPS1025H_32_DeInit,
  IPS1025H_32_ReadID,
  IPS1025H_32_GetCapabilities,
  IPS1025H_32_GetFaultStatus,
  IPS1025H_32_GetChannelStatus,
  IPS1025H_32_SetChannelStatus,
  IPS1025H_32_GetAllChannelStatus,
  IPS1025H_32_SetAllChannelStatus,
  IPS1025H_32_GetChannelFreq,
  IPS1025H_32_SetChannelFreq,
  IPS1025H_32_GetChannelDc,
  IPS1025H_32_SetChannelDc,
  IPS1025H_32_GetPwmEnable,
  IPS1025H_32_SetPwmEnable,
  IPS1025H_32_PwmTick
};
...
/** @defgroup IPS1025H_32_Private_Variables IPS1025H_32 Private Variables
  * @{
  */
...
/** @defgroup IPS1025H_32_Private_Function_Prototypes IPS1025H_32 Private Function Prototypes
  * @{
  */

static int32_t IPS1025H_32_Initialize(IPS1025H_32_Object_t *pObj);
...
/** @defgroup IPS1025H_32_Functions_Definition IPS1025H_32 Functions Definition
  * @{
  */
...
/**
  * @brief  Initialize the IPS1025H_32 switch
  * @param  pObj pointer to the device object
  * @retval 0 in case of success, an error code otherwise
  */
int32_t IPS1025H_32_Init(IPS1025H_32_Object_t *pObj)
{
  ...
  {
    if (IPS1025H_32_Initialize(pObj) != IPS_SWITCH_OK)
    {
    ...
    {
      IPS_NbInstances++;
      if (IPS_NbInstances > IPS1025H_32_INSTANCES_NBR)
      {
        status = IPS_SWITCH_ERROR;
      }
      else
...
/**
  * @brief  Deinitialize the IPS1025H_32 switch
  * @param  pObj pointer to the device object
  * @retval 0 in case of success, an error code otherwise
  */
int32_t IPS1025H_32_DeInit(IPS1025H_32_Object_t *pObj)
{
  ...
  if (pObj->is_initialized == 1U)
  {
    ...
    {
        (void)IPS1025H_32_SetPwmEnable(pObj, (uint8_t)loop, 0U);
    }

     /* Disable all channels */
    (void)IPS1025H_32_SetAllChannelStatus(pObj, 0U);
...
/**
  * @brief  Get IPS1025H_32 switch capabilities
  * @param  pObj pointer to the device object
...
int32_t IPS1025H_32_GetCapabilities(IPS1025H_32_Object_t *pObj, IPS1025H_32_Capabilities_t *pCapabilities)
{
  ...
  if (pObj->chipId == IPS1025H_32_CHIP_ID)
  {
...
int32_t IPS1025H_32_SetChannelFreq(IPS1025H_32_Object_t *pObj, uint8_t ChanId, uint16_t ChanFreq)
{
  ...
  {
    uint16_t newFreq;
    if (ChanFreq > IPS1025H_32_MAX_CHAN_FREQ)
    {
       newFreq = IPS1025H_32_MAX_CHAN_FREQ;
    }
    else
    {
      newFreq = ChanFreq;
...
static int32_t IPS1025H_32_Initialize(IPS1025H_32_Object_t *pObj)
{
  ...
  if (IPS1025H_32_SetAllChannelStatus(pObj, 0U) != IPS_SWITCH_OK)
  {
    ret = IPS_SWITCH_ERROR;
  }
  return ret;
