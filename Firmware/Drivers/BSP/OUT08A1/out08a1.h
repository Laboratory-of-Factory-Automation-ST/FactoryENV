/**
  ...
  * @brief   Header for out08a1.c module
  ******************************************************************************
  * @attention
  *
...
/** @defgroup OUT08A1_Exported_Types OUT08A1 Exported Types
  * @{
  */
...
typedef struct
{
  /** PWM Frequency */
  uint32_t pwmFreq;
} OUT08_SWITCH_Init_Parameters_t;
...
/** @defgroup OUT08A1_Exported_Constants OUT08A1 Exported Constants
  * @{
  */

/** CHIP ID */
#define OUT08_SWITCH_CHIP_ID IPS_SWITCH_CHIP_ID

/** Number of supported switch instances */
#define OUT08_SWITCH_INSTANCES_NBR (4U)

/** Number of supported switch devices */
#define OUT08_SWITCH_DEVICES_NBR IPS_SWITCH_DEVICES_NBR

#ifdef USE_BOARD_0
/* Board 0 */
/** Device Chan: IN1 0 */
#define OUT08_SWITCH_0_IN1 IPS_SWITCH_0_IN1

/** Board Control Pin: Nch_DRV 0 */
#define OUT08_SWITCH_0_NCH_DRV IPS_SWITCH_0_NCH_DRV
/** Board Control Pin: OUT_FB 0 */
#define OUT08_SWITCH_0_OUT_FB IPS_SWITCH_0_OUT_FB

/** IN1 Port 0 */
#define OUT08_SWITCH_0_IN1_GPIO_PORT IPS_SWITCH_0_IN1_GPIO_PORT
/** IN1 Pin 0 */
#define OUT08_SWITCH_0_IN1_GPIO_PIN IPS_SWITCH_0_IN1_GPIO_PIN
/** DIAG Port 0 */
#define OUT08_SWITCH_0_DIAG_GPIO_PORT IPS_SWITCH_0_DIAG_GPIO_PORT
/** DIAG Pin 0 */
#define OUT08_SWITCH_0_DIAG_GPIO_PIN IPS_SWITCH_0_DIAG_GPIO_PIN
/** Nch-DRV Port 0 */
#define OUT08_SWITCH_0_NCH_DRV_GPIO_PORT IPS_SWITCH_0_NCH_DRV_GPIO_PORT
/** Nch-DRV Pin 0 */
#define OUT08_SWITCH_0_NCH_DRV_GPIO_PIN IPS_SWITCH_0_NCH_DRV_GPIO_PIN
/** OUT_FB Port 0 */
#define OUT08_SWITCH_0_OUT_FB_GPIO_PORT IPS_SWITCH_0_OUT_FB_GPIO_PORT
/** OUT_FB Pin 0 */
#define OUT08_SWITCH_0_OUT_FB_GPIO_PIN IPS_SWITCH_0_OUT_FB_GPIO_PIN
#endif /* #ifdef USE_BOARD_0 */

#ifdef USE_BOARD_1
/* Board 1 */
/** Device Chan: IN1 1 */
#define OUT08_SWITCH_1_IN1 IPS_SWITCH_1_IN1

/** Board Control Pin: Nch_DRV 1 */
#define OUT08_SWITCH_1_NCH_DRV IPS_SWITCH_1_NCH_DRV
/** Board Control Pin: OUT_FB 1 */
#define OUT08_SWITCH_1_OUT_FB IPS_SWITCH_1_OUT_FB

/** IN1 Port 1 */
#define OUT08_SWITCH_1_IN1_GPIO_PORT IPS_SWITCH_1_IN1_GPIO_PORT
/** IN1 Pin 1 */
#define OUT08_SWITCH_1_IN1_GPIO_PIN IPS_SWITCH_1_IN1_GPIO_PIN
/** DIAG Port 1 */
#define OUT08_SWITCH_1_DIAG_GPIO_PORT IPS_SWITCH_1_DIAG_GPIO_PORT
/** DIAG Pin 1 */
#define OUT08_SWITCH_1_DIAG_GPIO_PIN IPS_SWITCH_1_DIAG_GPIO_PIN
/** Nch-DRV Port 1 */
#define OUT08_SWITCH_1_NCH_DRV_GPIO_PORT IPS_SWITCH_1_NCH_DRV_GPIO_PORT
/** Nch-DRV Pin 1 */
#define OUT08_SWITCH_1_NCH_DRV_GPIO_PIN IPS_SWITCH_1_NCH_DRV_GPIO_PIN
/** OUT_FB Port 1 */
#define OUT08_SWITCH_1_OUT_FB_GPIO_PORT IPS_SWITCH_1_OUT_FB_GPIO_PORT
/** OUT_FB Pin 1 */
#define OUT08_SWITCH_1_OUT_FB_GPIO_PIN IPS_SWITCH_1_OUT_FB_GPIO_PIN
#endif /* #ifdef USE_BOARD_1 */

#ifdef USE_BOARD_2
/* Board 2 */
/** Device Chan: IN1 2 */
#define OUT08_SWITCH_2_IN1 IPS_SWITCH_2_IN1

/** Board Control Pin: Nch_DRV 2 */
#define OUT08_SWITCH_2_NCH_DRV IPS_SWITCH_2_NCH_DRV
/** Board Control Pin: OUT_FB 2 */
#define OUT08_SWITCH_2_OUT_FB IPS_SWITCH_2_OUT_FB

/** IN1 Port 2 */
#define OUT08_SWITCH_2_IN1_GPIO_PORT IPS_SWITCH_2_IN1_GPIO_PORT
/** IN1 Pin 2 */
#define OUT08_SWITCH_2_IN1_GPIO_PIN IPS_SWITCH_2_IN1_GPIO_PIN
/** DIAG Port 2 */
#define OUT08_SWITCH_2_DIAG_GPIO_PORT IPS_SWITCH_2_DIAG_GPIO_PORT
/** DIAG Pin 2 */
#define OUT08_SWITCH_2_DIAG_GPIO_PIN IPS_SWITCH_2_DIAG_GPIO_PIN
/** Nch-DRV Port 2 */
#define OUT08_SWITCH_2_NCH_DRV_GPIO_PORT IPS_SWITCH_2_NCH_DRV_GPIO_PORT
/** Nch-DRV Pin 2 */
#define OUT08_SWITCH_2_NCH_DRV_GPIO_PIN IPS_SWITCH_2_NCH_DRV_GPIO_PIN
/** OUT_FB Port 2 */
#define OUT08_SWITCH_2_OUT_FB_GPIO_PORT IPS_SWITCH_2_OUT_FB_GPIO_PORT
/** OUT_FB Pin 2 */
#define OUT08_SWITCH_2_OUT_FB_GPIO_PIN IPS_SWITCH_2_OUT_FB_GPIO_PIN
#endif /* #ifdef USE_BOARD_2 */

#ifdef USE_BOARD_3
/* Board 3 */
/** Device Chan: IN1 3 */
#define OUT08_SWITCH_3_IN1 IPS_SWITCH_3_IN1

/** Board Control Pin: Nch_DRV 3 */
#define OUT08_SWITCH_3_NCH_DRV IPS_SWITCH_3_NCH_DRV
/** Board Control Pin: OUT_FB 3 */
#define OUT08_SWITCH_3_OUT_FB IPS_SWITCH_3_OUT_FB

/** IN1 Port 3 */
#define OUT08_SWITCH_3_IN1_GPIO_PORT IPS_SWITCH_3_IN1_GPIO_PORT
/** IN1 Pin 3 */
#define OUT08_SWITCH_3_IN1_GPIO_PIN IPS_SWITCH_3_IN1_GPIO_PIN
/** DIAG Port 3 */
#define OUT08_SWITCH_3_DIAG_GPIO_PORT IPS_SWITCH_3_DIAG_GPIO_PORT
/** DIAG Pin 3 */
#define OUT08_SWITCH_3_DIAG_GPIO_PIN IPS_SWITCH_3_DIAG_GPIO_PIN
/** Nch-DRV Port 3 */
#define OUT08_SWITCH_3_NCH_DRV_GPIO_PORT IPS_SWITCH_3_NCH_DRV_GPIO_PORT
/** Nch-DRV Pin 3 */
#define OUT08_SWITCH_3_NCH_DRV_GPIO_PIN IPS_SWITCH_3_NCH_DRV_GPIO_PIN
/** OUT_FB Port 3 */
#define OUT08_SWITCH_3_OUT_FB_GPIO_PORT IPS_SWITCH_3_OUT_FB_GPIO_PORT
/** OUT_FB Pin 3 */
#define OUT08_SWITCH_3_OUT_FB_GPIO_PIN IPS_SWITCH_3_OUT_FB_GPIO_PIN
...
/** @defgroup OUT08A1_Exported_Variables OUT08A1 Exported Variables
  * @{
  */

extern void *SWITCH_CompObj[OUT08_SWITCH_INSTANCES_NBR];
...
/** @defgroup OUT08A1_Exported_Functions OUT08A1 Exported Functions
  * @{
  */
