/**
  ...
  * @brief   Header for out12a1.c module
  ******************************************************************************
  * @attention
  *
...
/** @defgroup OUT12A1_Exported_Types OUT12A1 Exported Types
  * @{
  */
...
/** @defgroup OUT12A1_Exported_Constants OUT12A1 Exported Constants
  * @{
  */

/** CHIP ID  */
#define OUT12_RELAY_CHIP_ID IPS_RELAY_CHIP_ID

/** Number of supported relay instances*/
#define OUT12_RELAY_INSTANCES_NBR (2U)

/** Number of supported relay devices*/
#define OUT12_RELAY_DEVICES_NBR IPS_RELAY_DEVICES_NBR

/** Undefined Control mode setting */
#define OUT12_RELAY_UNDEF_MODE IPS_RELAY_UNDEF_MODE

/** Synchronous Control mode setting */
#define OUT12_RELAY_PAR_IND_MODE IPS_RELAY_PAR_IND_MODE

/** Direct Control mode setting */
#define OUT12_RELAY_DAISY_CHAIN_MODE IPS_RELAY_DAISY_CHAIN_MODE

/** Fully populated system in daisy chain mode */
#define OUT12_RELAY_DAISY_CHAIN_FULLSYS IPS_RELAY_DAISY_CHAIN_FULLSYS

/** SPI frequency for relay */
#define OUT12_RELAY_CONF_PARAM_SPI_FREQ IPS_RELAY_CONF_PARAM_SPI_FREQ

/** Tcss delay in us */
#define OUT12_RELAY_CONF_PARAM_TIMING_TCSS IPS_RELAY_CONF_PARAM_TIMING_TCSS

/* Dev pins */
#ifdef USE_BOARD_0
/* Board 0 */
/** Device Chan: IN1 */
#define OUT12_RELAY_0_IN1 IPS_RELAY_0_IN1
/** Device Chan: IN2 */
#define OUT12_RELAY_0_IN2 IPS_RELAY_0_IN2
/** Device Chan: IN3 */
#define OUT12_RELAY_0_IN3 IPS_RELAY_0_IN3
/** Device Chan: IN4 */
#define OUT12_RELAY_0_IN4 IPS_RELAY_0_IN4
/** Device Chan: IN5 */
#define OUT12_RELAY_0_IN5 IPS_RELAY_0_IN5
/** Device Chan: IN6 */
#define OUT12_RELAY_0_IN6 IPS_RELAY_0_IN6
/** Device Chan: IN7 */
#define OUT12_RELAY_0_IN7 IPS_RELAY_0_IN7
/** Device Chan: IN8 */
#define OUT12_RELAY_0_IN8 IPS_RELAY_0_IN8

/** Input Pin: SPI_CLK */
#define OUT12_RELAY_0_SPI_CLK IPS_RELAY_0_SPI_CLK
/** Input Pin: SPI_MISO */
#define OUT12_RELAY_0_SPI_MISO IPS_RELAY_0_SPI_MISO
/** Input Pin: SPI_MOSI */
#define OUT12_RELAY_0_SPI_MOSI IPS_RELAY_0_SPI_MOSI

/** Control Pin: SPI_SS */
#define OUT12_RELAY_0_SPI_SS IPS_RELAY_0_SPI_SS
/** Control Pin: OUT_EN */
#define OUT12_RELAY_0_OUT_EN IPS_RELAY_0_OUT_EN

/** SPI_SS Port 0 */
#define OUT12_RELAY_0_SPI_SS_GPIO_PORT IPS_RELAY_0_SPI_SS_GPIO_PORT
/** SPI_SS Pin 0 */
#define OUT12_RELAY_0_SPI_SS_GPIO_PIN IPS_RELAY_0_SPI_SS_GPIO_PIN
/** OUT_EN Port 0 */
#define OUT12_RELAY_0_OUT_EN_GPIO_PORT IPS_RELAY_0_OUT_EN_GPIO_PORT
/** OUT_EN Pin 0 */
#define OUT12_RELAY_0_OUT_EN_GPIO_PIN IPS_RELAY_0_OUT_EN_GPIO_PIN

/** STATUS Port 0 */
#define OUT12_RELAY_0_STATUS_GPIO_PORT IPS_RELAY_0_STATUS_GPIO_PORT
/** STATUS Pin 0 */
#define OUT12_RELAY_0_STATUS_GPIO_PIN IPS_RELAY_0_STATUS_GPIO_PIN
/** PGOOD Port 0 */
#define OUT12_RELAY_0_PGOOD_GPIO_PORT IPS_RELAY_0_PGOOD_GPIO_PORT
/** PGOOD Pin 0 */
#define OUT12_RELAY_0_PGOOD_GPIO_PIN IPS_RELAY_0_PGOOD_GPIO_PIN
#endif /* #ifdef USE_BOARD_0 */

#ifdef USE_BOARD_1
/* Board 1 */
/** Device Chan: IN1 */
#define OUT12_RELAY_1_IN1 IPS_RELAY_1_IN1
/** Device Chan: IN2 */
#define OUT12_RELAY_1_IN2 IPS_RELAY_1_IN2
/** Device Chan: IN3 */
#define OUT12_RELAY_1_IN3 IPS_RELAY_1_IN3
/** Device Chan: IN4 */
#define OUT12_RELAY_1_IN4 IPS_RELAY_1_IN4
/** Device Chan: IN5 */
#define OUT12_RELAY_1_IN5 IPS_RELAY_1_IN5
/** Device Chan: IN6 */
#define OUT12_RELAY_1_IN6 IPS_RELAY_1_IN6
/** Device Chan: IN7 */
#define OUT12_RELAY_1_IN7 IPS_RELAY_1_IN7
/** Device Chan: IN8 */
#define OUT12_RELAY_1_IN8 IPS_RELAY_1_IN8

/** Input Pin: SPI_CLK */
#define OUT12_RELAY_1_SPI_CLK IPS_RELAY_1_SPI_CLK
/** Input Pin: SPI_MISO */
#define OUT12_RELAY_1_SPI_MISO IPS_RELAY_1_SPI_MISO
/** Input Pin: SPI_MOSI */
#define OUT12_RELAY_1_SPI_MOSI IPS_RELAY_1_SPI_MOSI

/** Control Pin: SPI_SS */
#define OUT12_RELAY_1_SPI_SS IPS_RELAY_1_SPI_SS
/** Control Pin: OUT_EN_Alt1 */
#define OUT12_RELAY_1_OUT_EN IPS_RELAY_1_OUT_EN

/** SPI_SS Port 0 */
#define OUT12_RELAY_1_SPI_SS_GPIO_PORT IPS_RELAY_1_SPI_SS_GPIO_PORT
/** SPI_SS Pin 0 */
#define OUT12_RELAY_1_SPI_SS_GPIO_PIN IPS_RELAY_1_SPI_SS_GPIO_PIN
/** OUT_EN Port 0 */
#define OUT12_RELAY_1_OUT_EN_GPIO_PORT IPS_RELAY_1_OUT_EN_GPIO_PORT
/** OUT_EN Pin 0 */
#define OUT12_RELAY_1_OUT_EN_GPIO_PIN IPS_RELAY_1_OUT_EN_GPIO_PIN

/** STATUS Port 0 */
#define OUT12_RELAY_1_STATUS_GPIO_PORT IPS_RELAY_1_STATUS_GPIO_PORT
/** STATUS Pin 0 */
#define OUT12_RELAY_1_STATUS_GPIO_PIN IPS_RELAY_1_STATUS_GPIO_PIN
/** PGOOD Port 0 */
#define OUT12_RELAY_1_PGOOD_GPIO_PORT IPS_RELAY_1_PGOOD_GPIO_PORT
/** PGOOD Pin 0 */
#define OUT12_RELAY_1_PGOOD_GPIO_PIN IPS_RELAY_1_PGOOD_GPIO_PIN
...
/** @addtogroup OUT12A1_Exported_Variables OUT12A1 Exported Variables
  * @{
  */

extern void *RELAY_CompObj[OUT12_RELAY_INSTANCES_NBR];
...
/** @addtogroup OUT12A1_Exported_Functions OUT12A1 Exported Functions
  * @{
  */
/* Common functions */
...
int32_t OUT12_RELAY_GetCtrlPinStatus(uint8_t Instance, uint8_t CtrlPinId, uint8_t *pCtrlPinStatus);
