...
/** @defgroup OUT12A1_BUS_Functions_Definition OUT12A1_BUS Functions Definition
 * @{
 */
...
/**
  * @brief   Write and read SPI byte to the Iso808a's
...
uint8_t OUT12_Board_SpiWrite(uint8_t deviceId, uint8_t *pByteToTransmit, uint8_t *pReceivedByte, uint8_t nbDevices)
{
  ...
  switch(deviceId)
  {
    case 0U:
#ifdef USE_BOARD_0
      HAL_GPIO_WritePin(OUT12_RELAY_0_SPI_SS_GPIO_PORT, OUT12_RELAY_0_SPI_SS_GPIO_PIN, GPIO_PIN_RESET);
#endif /* #ifdef USE_BOARD_0 */
      break;

    case 1U:
#ifdef USE_BOARD_1
      HAL_GPIO_WritePin(OUT12_RELAY_1_SPI_SS_GPIO_PORT, OUT12_RELAY_1_SPI_SS_GPIO_PIN, GPIO_PIN_RESET);
  ...
  if (status == 0)
  {
    ...
    {
      status = OUT12_Spi_SendRecv( pByteToTransmit, pReceivedByte, 1U);
      if (status != 0)
      {
        break;
      }
    ...
    switch(deviceId)
    {
      case 0U:
#ifdef USE_BOARD_0
        HAL_GPIO_WritePin(OUT12_RELAY_0_SPI_SS_GPIO_PORT, OUT12_RELAY_0_SPI_SS_GPIO_PIN, GPIO_PIN_SET);
#endif /* #ifdef USE_BOARD_0 */
        break;

      case 1U:
#ifdef USE_BOARD_1
        HAL_GPIO_WritePin(OUT12_RELAY_1_SPI_SS_GPIO_PORT, OUT12_RELAY_1_SPI_SS_GPIO_PIN, GPIO_PIN_SET);
#endif /* #ifdef USE_BOARD_1 */
        break;
...
#ifdef USE_BOARD_0
    case OUT12_RELAY_0_SPI_SS:
#endif /* #ifdef USE_BOARD_0 */
#ifdef USE_BOARD_1
    case OUT12_RELAY_1_SPI_SS:
#endif /* #ifdef USE_BOARD_1 */
...
#ifdef USE_BOARD_0
    case OUT12_RELAY_0_OUT_EN:
#endif /* #ifdef USE_BOARD_0 */
#ifdef USE_BOARD_1
    case OUT12_RELAY_1_OUT_EN:
#endif /* #ifdef USE_BOARD_1 */
#if (USE_BOARD_0||USE_BOARD_1)
