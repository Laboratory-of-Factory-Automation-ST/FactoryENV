...
/** @addtogroup OUT17A1_BUS OUT17A1_BUS
  * @{
  */
...
/** @defgroup OUT17A1_BUS_Functions_Definition OUT17A1_BUS Functions Definition
 * @{
 */
...
int32_t OUT17_SetControlPin(IPS_RELAY_Pins_t *Pin, uint8_t PinId, uint8_t PinStatus)
{
  ...
  switch(PinId)
  {
    /* Control pins management */
#ifdef USE_BOARD_0
    case OUT17_RELAY_0_SPI_SS:
#endif /* #ifdef USE_BOARD_0 */
#ifdef USE_BOARD_1
    case OUT17_RELAY_1_SPI_SS:
...
#ifdef USE_BOARD_0
    case OUT17_RELAY_0_OUT_EN:
#endif /* #ifdef USE_BOARD_0 */
#ifdef USE_BOARD_1
    case OUT17_RELAY_1_OUT_EN:
#endif /* #ifdef USE_BOARD_1 */
#if (USE_BOARD_0||USE_BOARD_1)
...
#ifdef USE_BOARD_0
    case OUT17_RELAY_0_WD:
#endif /* #ifdef USE_BOARD_0 */
#ifdef USE_BOARD_1
    case OUT17_RELAY_1_WD:
#endif /* #ifdef USE_BOARD_1 */
#if (USE_BOARD_0||USE_BOARD_1)
...
#ifdef USE_BOARD_0
    case OUT17_RELAY_0_SEL2_L:
#endif /* #ifdef USE_BOARD_0 */
#ifdef USE_BOARD_1
    case OUT17_RELAY_1_SEL2_L:
#endif /* #ifdef USE_BOARD_1 */
#if (USE_BOARD_0||USE_BOARD_1)
      *PinStatus = (uint8_t) HAL_GPIO_ReadPin(Pin->SEL2_L_GPort, Pin->SEL2_L_GPin);
#endif /* #ifdef (USE_BOARD_0||USE_BOARD_1) */
...
#ifdef USE_BOARD_0
    case OUT17_RELAY_0_SEL1:
#endif /* #ifdef USE_BOARD_0 */
#ifdef USE_BOARD_1
    case OUT17_RELAY_1_SEL1:
#endif /* #ifdef USE_BOARD_1 */
#if (USE_BOARD_0||USE_BOARD_1)
      *PinStatus = (uint8_t) HAL_GPIO_ReadPin(Pin->SEL1_GPort, Pin->SEL1_GPin);
#endif /* #ifdef (USE_BOARD_0||USE_BOARD_1) */
...
#ifdef USE_BOARD_0
    case OUT17_RELAY_0_WDEN:
#endif /* #ifdef USE_BOARD_0 */
#ifdef USE_BOARD_1
    case OUT17_RELAY_1_WDEN:
#endif /* #ifdef USE_BOARD_1 */
#if (USE_BOARD_0||USE_BOARD_1)
...
/**
  * @brief   Write and read SPI byte to the IPS8200HQ-1's
...
uint8_t OUT17_Board_SpiWrite(uint8_t deviceId, uint8_t *pByteToTransmit, uint8_t *pReceivedByte, uint8_t nbDevices)
{
  ...
  switch(deviceId)
  {
    case 0U:
#ifdef USE_BOARD_0
      HAL_GPIO_WritePin(OUT17_RELAY_0_SPI_SS_GPIO_PORT, OUT17_RELAY_0_SPI_SS_GPIO_PIN, GPIO_PIN_RESET);
#endif /* #ifdef USE_BOARD_0 */
      break;

    case 1U:
#ifdef USE_BOARD_1
      HAL_GPIO_WritePin(OUT17_RELAY_1_SPI_SS_GPIO_PORT, OUT17_RELAY_1_SPI_SS_GPIO_PIN, GPIO_PIN_RESET);
#endif /* #ifdef USE_BOARD_1 */
      break;
  ...
  if (status == 0)
  {
    ...
    {
      status = OUT17_Spi_SendRecv(pByteToTransmit, pReceivedByte, 1U);
      if (status != 0)
      {
        break;
      }
    ...
    switch(deviceId)
    {
      case 0U:
#ifdef USE_BOARD_0
        HAL_GPIO_WritePin(OUT17_RELAY_0_SPI_SS_GPIO_PORT, OUT17_RELAY_0_SPI_SS_GPIO_PIN, GPIO_PIN_SET);
#endif /* #ifdef USE_BOARD_0 */
        break;

      case 1U:
#ifdef USE_BOARD_1
        HAL_GPIO_WritePin(OUT17_RELAY_1_SPI_SS_GPIO_PORT, OUT17_RELAY_1_SPI_SS_GPIO_PIN, GPIO_PIN_SET);
#endif /* #ifdef USE_BOARD_1 */
        break;
