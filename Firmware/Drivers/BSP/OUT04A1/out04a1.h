/**
  ...
  * @brief   Header for out04a1.c module
  ******************************************************************************
  * @attention
  *
...
/* Includes ------------------------------------------------------------------*/
#include "out04a1_conf.h"
#include "out04a1_bus.h"
...
/** @defgroup OUT04A1_Exported_Types OUT04A1 Exported Types
  * @{
  */
...
typedef struct
{
  /** PWM Frequency */
  uint32_t pwmFreq;
} OUT04_SWITCH_Init_Parameters_t;
...
/** @defgroup OUT04A1_Exported_Constants OUT04A1 Exported Constants
  * @{
  */

/** CHIP ID */
#define OUT04_SWITCH_CHIP_ID IPS_SWITCH_CHIP_ID

/** Number of supported switch instances*/
#define OUT04_SWITCH_INSTANCES_NBR (4U)

/** Number of supported switch devices*/
#define OUT04_SWITCH_DEVICES_NBR IPS_SWITCH_DEVICES_NBR

#ifdef USE_BOARD_0
/* Board 0 */
/** IN1 Port 0 */
#define OUT04_SWITCH_0_IN1_GPIO_PORT IPS_SWITCH_0_IN1_GPIO_PORT
/** IN1 Pin 0 */
#define OUT04_SWITCH_0_IN1_GPIO_PIN IPS_SWITCH_0_IN1_GPIO_PIN
/** IN2 Port 0 */
#define OUT04_SWITCH_0_IN2_GPIO_PORT IPS_SWITCH_0_IN2_GPIO_PORT
/** IN2 Pin 0 */
#define OUT04_SWITCH_0_IN2_GPIO_PIN IPS_SWITCH_0_IN2_GPIO_PIN
/** FLT1 Port 0 */
#define OUT04_SWITCH_0_FLT1_GPIO_PORT IPS_SWITCH_0_FLT1_GPIO_PORT
/** FLT1 Pin 0 */
#define OUT04_SWITCH_0_FLT1_GPIO_PIN IPS_SWITCH_0_FLT1_GPIO_PIN
/** FLT2 Port 0 */
#define OUT04_SWITCH_0_FLT2_GPIO_PORT IPS_SWITCH_0_FLT2_GPIO_PORT
/** FLT2 Pin 0 */
#define OUT04_SWITCH_0_FLT2_GPIO_PIN IPS_SWITCH_0_FLT2_GPIO_PIN
#endif /* #ifdef USE_BOARD_0 */

#ifdef USE_BOARD_1
/* Board 1 */
/** IN1 Port 0 */
#define OUT04_SWITCH_1_IN1_GPIO_PORT IPS_SWITCH_1_IN1_GPIO_PORT
/** IN1 Pin 0 */
#define OUT04_SWITCH_1_IN1_GPIO_PIN IPS_SWITCH_1_IN1_GPIO_PIN
/** IN2 Port 0 */
#define OUT04_SWITCH_1_IN2_GPIO_PORT IPS_SWITCH_1_IN2_GPIO_PORT
/** IN2 Pin 0 */
#define OUT04_SWITCH_1_IN2_GPIO_PIN IPS_SWITCH_1_IN2_GPIO_PIN
/** FLT1 Port 0 */
#define OUT04_SWITCH_1_FLT1_GPIO_PORT IPS_SWITCH_1_FLT1_GPIO_PORT
/** FLT1 Pin 0 */
#define OUT04_SWITCH_1_FLT1_GPIO_PIN IPS_SWITCH_1_FLT1_GPIO_PIN
/** FLT2 Port 0 */
#define OUT04_SWITCH_1_FLT2_GPIO_PORT IPS_SWITCH_1_FLT2_GPIO_PORT
/** FLT2 Pin 0 */
#define OUT04_SWITCH_1_FLT2_GPIO_PIN IPS_SWITCH_1_FLT2_GPIO_PIN
#endif /* #ifdef USE_BOARD_1 */

#ifdef USE_BOARD_2
/* Board 2 */
/** IN1 Port 0 */
#define OUT04_SWITCH_2_IN1_GPIO_PORT IPS_SWITCH_2_IN1_GPIO_PORT
/** IN1 Pin 0 */
#define OUT04_SWITCH_2_IN1_GPIO_PIN IPS_SWITCH_2_IN1_GPIO_PIN
/** IN2 Port 0 */
#define OUT04_SWITCH_2_IN2_GPIO_PORT IPS_SWITCH_2_IN2_GPIO_PORT
/** IN2 Pin 0 */
#define OUT04_SWITCH_2_IN2_GPIO_PIN IPS_SWITCH_2_IN2_GPIO_PIN
/** FLT1 Port 0 */
#define OUT04_SWITCH_2_FLT1_GPIO_PORT IPS_SWITCH_2_FLT1_GPIO_PORT
/** FLT1 Pin 0 */
#define OUT04_SWITCH_2_FLT1_GPIO_PIN IPS_SWITCH_2_FLT1_GPIO_PIN
/** FLT2 Port 0 */
#define OUT04_SWITCH_2_FLT2_GPIO_PORT IPS_SWITCH_2_FLT2_GPIO_PORT
/** FLT2 Pin 0 */
#define OUT04_SWITCH_2_FLT2_GPIO_PIN IPS_SWITCH_2_FLT2_GPIO_PIN
#endif /* #ifdef USE_BOARD_2 */

#ifdef USE_BOARD_3
/* Board 3 */
/** IN1 Port 0 */
#define OUT04_SWITCH_3_IN1_GPIO_PORT IPS_SWITCH_3_IN1_GPIO_PORT
/** IN1 Pin 0 */
#define OUT04_SWITCH_3_IN1_GPIO_PIN IPS_SWITCH_3_IN1_GPIO_PIN
/** IN2 Port 0 */
#define OUT04_SWITCH_3_IN2_GPIO_PORT IPS_SWITCH_3_IN2_GPIO_PORT
/** IN2 Pin 0 */
#define OUT04_SWITCH_3_IN2_GPIO_PIN IPS_SWITCH_3_IN2_GPIO_PIN
/** FLT1 Port 0 */
#define OUT04_SWITCH_3_FLT1_GPIO_PORT IPS_SWITCH_3_FLT1_GPIO_PORT
/** FLT1 Pin 0 */
#define OUT04_SWITCH_3_FLT1_GPIO_PIN IPS_SWITCH_3_FLT1_GPIO_PIN
/** FLT2 Port 0 */
#define OUT04_SWITCH_3_FLT2_GPIO_PORT IPS_SWITCH_3_FLT2_GPIO_PORT
/** FLT2 Pin 0 */
#define OUT04_SWITCH_3_FLT2_GPIO_PIN IPS_SWITCH_3_FLT2_GPIO_PIN
...
/** @addtogroup OUT04A1_Exported_Variables OUT04A1 Exported Variables
  * @{
  */

extern void *SWITCH_CompObj[OUT04_SWITCH_INSTANCES_NBR];
...
/** @addtogroup OUT04A1_Exported_Functions OUT04A1 Exported Functions
  * @{
  */
