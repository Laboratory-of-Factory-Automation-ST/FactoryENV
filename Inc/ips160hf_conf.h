/**
  ******************************************************************************
  * @file    ips160hf_conf.h
  * @author  AMS IPC IO-Link Application Team
  * @brief   Predefines values for the IPS160HF parameters
  ******************************************************************************
  * @attention
  *
...
#ifndef IPS160HF_CONF_H
#define IPS160HF_CONF_H
...
#define IPS160HF_INSTANCES_NBR (1U)
