/**
  ******************************************************************************
  * @file    ips161hf_conf.h
  * @author  AMS IPC IO-Link Application Team
  * @brief   Predefines values for the IPS161HF parameters
  ******************************************************************************
  * @attention
  *
...
#ifndef IPS161HF_CONF_H
#define IPS161HF_CONF_H
...
#define IPS161HF_INSTANCES_NBR (1U)
